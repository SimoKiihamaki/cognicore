...
const ChatInterface = ({ asSidebar = false }: ChatInterfaceProps) => {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className={`p-4 border-b border-border ${asSidebar ? 'hidden sm:block' : ''}`}>
        ...
        <div className="glass rounded-xl overflow-hidden">
          <div className="flex items-end">
            <textarea
              ...
              className="flex-1 bg-transparent border-0 p-2.5 max-h-32 focus:outline-none resize-none scrollbar-thin text-sm"
              style={{ height: '40px' }}
            />
